...
<form id="form_guardar" name="form_guardar" method="POST" action="{{ route('proveedor.guardar') }}" onsubmit="confirmar()">
    @csrf
    ...
    <div class="form-group">
        ...
        pattern="([3, 8-9][0-9]{7})" required value="{{old('TeléfonoDeLaEmpresa')}}">
    </div>
    ...
    <div class="form-group">
        ...
        pattern="([3, 8-9][0-9]{7})" required value="{{old('TeléfonoDelEncargado')}}">
    </div>
