...
@section('contenido')
    <div class="container-fluid">
        ...
        <form id="form_guardar" name="form_guardar" method="POST" action="{{ route('ventas.guardar') }}"
            ...
            <div class="row" style="width: 100%">
                <div class="col-sm-12">
                    <button data-toggle="modal" data-target="#agreagar_detalle" type="button"
                    ...
                    <form action="{{ route('rango.crear') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row" style="width: 100%">
                                ...
                                <input type="text" name="r_Idcliente" id="r_Idcliente" value="{{ $client }}" hidden>
                                <script>
                                    function fr() {
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input style="width: 100%" type="number" name="Fin" id="Fin" class="form-control"
                                            placeholder="Número de factura sin guiones" pattern="[0-9]{16}" required
                                            value="{{ old('Fin') }}" maxlength="16">
                                    </div>
                                </div>
                                <?php
                    ...
                    <form action="{{ route('detalle_venta.crear') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="row" style="width: 100%">
                                ...
                                <input type="text" name="Idcliente" id="Idcliente" value="{{ $client }}" hidden>
                                <div class="col-sm-6">
                                    <div class="form-group">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" style="width: 100%">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="e_Idcliente" id="e_Idcliente" value="{{ $client }}"
                                            hidden>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <input class="form-control" id="e_calimp"
                                    style="width: 95%;text-align: center;color: black" type="text" value="" disabled>
                            </div>
